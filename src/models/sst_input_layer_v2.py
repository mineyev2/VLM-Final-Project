...
from .sst_ops import flat2window_v2, window2flat_v2, get_inner_win_inds, make_continuous_inds, get_flat2win_inds_v2, get_window_coors
import random
import pickle as pkl
import os

@MODELS.register_module()  # ✅ UPDATED: Use MODELS instead of MIDDLE_ENCODERS
class SSTInputLayerV2(nn.Module):
    ...
    @autocast(dtype=torch.float16)  # ✅ UPDATED: Modern autocast syntax
